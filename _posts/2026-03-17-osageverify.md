...
We must not let these forces of surveillance — and the pursuit of quarterly profits at all costs — erode our ability to freely access computers and information. These laws, as nefarious as they really are, gain ground because they are sold to the public and to lawmakers as necessary to protect children from pornography, predators, and screen addiction. To be clear: these are real issues. Screen addiction is real and it impacts all of us. [Half](https://safecomputing.umich.edu/events/privacy/dr-lauren-girouard) of all US children between the ages of 10-12 now have social media accounts. These problems deserve serious attention and serious solutions. What's being proposed is neither.

Here is what I think genuine solutions actually look like.

### Fund independent research and digital citizenship education. 
Companies like [Common Sense Media](https://www.commonsensemedia.org/) are doing important work trying to help parents and kids navigate the digital world responsibly. We should go further. What if Congress passed bills designating real money to bring together researchers, child psychologists, and educators to study the actual effects of screen time and social media on children — not research funded by the platforms themselves — and then used those findings to develop high-quality digital citizenship curriculum for schools and resources for parents? Equip parents and kids with real tools and real knowledge. That would do more for child safety than any age verification mandate.

### Regulate the addiction machine 
When it comes to screen addiction, we need to legislate the companies that created it. Facebook and its peers have spent millions becoming psychological hackers. They studied what casino designers have known for decades and built the same mechanics into social media: the pull-to-refresh gesture mimics a slot machine lever, delivering unpredictable rewards on a variable schedule — the most powerfully addictive conditioning pattern in behavioral psychology. The appearance of likes, the notification badge engineered to trigger anxiety, the infinite scroll with no natural stopping point — none of this is accidental. These are deliberate design decisions, refined through A/B testing on billions of users.

Most insidiously, consider the way Facebook curates information. It doesn't just show you posts — it decides which posts you see, in what order, and how prominently, based on one goal: keeping you on the platform as long as possible. Your psychological profile is studied. Content that triggers outrage, fear, and tribal anger gets surfaced. Content that informs or connects gets buried. Comment sections are manipulated by the same logic. The result is not just screen addiction — it is the intense partisan division that is currently ripping our country apart.

Because of the vitriol and polarization fueled by this curation, some lawmakers have proposed eliminating Section 230 entirely. For those unfamiliar: [Section 230](https://www.eff.org/issues/cda230) was created in 1996 and protects websites from liability for content posted by their users. This protection is genuinely important and must be preserved. One of my favorite sites, [Privacyguides.org](https://www.privacyguides.org/), has a community discussion board. Without Section 230, they could be sued into oblivion over a comment left by a stranger. Reddit, Wikipedia, and thousands of independent communities exist because of this law. Removing it outright would unleash a wave of litigation that the small, independent, privacy-respecting corners of the internet could never survive.

But Section 230 was written at a time when sites simply passively hosted content — posts shown in simple chronological order. It was never designed to protect against the algorithmic amplification Facebook does today. Section 230 is important, but it can be modified. That's why I drafted the Platform Accountability and Consumer Empowerment Act — the PACE Act. The full text is available [here](https://drive.proton.me/urls/BF4PJN6RGM#xTdzAAZPcyCF). I am not a politician, and I have no doubt it can be improved. I would love for the privacy and legal communities to examine it and offer input — my goal is to help, not to accidentally cause harm. Consider this a first draft and an open invitation.

#### What the PACE Act does
- Preserves full Section 230 immunity for platforms that deliver content through user-directed means — chronological feeds, search results ranked by relevance, hashtag subscriptions, and decentralized protocols.
- Removes immunity for algorithmic amplification: any system that selects, prioritizes, or ranks content based on predicted engagement rather than user intent.
- Requires an opt-out. Platforms using algorithmic amplification must offer users a clearly accessible option to switch to a non-algorithmic, chronological feed. Platforms that deliver content through that user-directed feed retain full immunity for that delivery.
- Explicitly protects content moderation — removing or demoting content that violates terms of service remains fully protected regardless of algorithm use.
- Does not ban algorithms. But when a platform makes the editorial choice to amplify specific content to millions of people, it can be held accountable for that choice — as any publisher would be.

If you want to see what a user-directed feed looks like in practice, try [Mastodon](https://mastodon.social/explore). It's a decentralized social network — a kind of open-source Twitter — where your feed is a simple chronological display of posts from the accounts you choose to follow. No algorithm buries the posts you actually care about to surface outrage bait. No psychological profiling. What you see is what the people you follow actually said, in the order they said it. All posts get equal footing. That's what the PACE Act protects — and it's what the major platforms should be held accountable for abandoning.

### Regulate data brokers directly. 
Finally, pass a federal privacy law with real teeth. The people-search sites that enabled the murder of a Minnesota lawmaker, and the ad-tech pipeline that lets federal agencies buy location data without a warrant, are not inevitable features of the internet. They are regulatory failures. Close the loophole that lets the government purchase what it cannot constitutionally seize. Make data brokers responsible for the harm their products enable.
